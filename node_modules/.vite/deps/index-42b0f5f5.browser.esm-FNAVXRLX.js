  ...
  "node_modules/typedarray-to-buffer/index.js"(exports, module) {
    ...
    module.exports = function typedarrayToBuffer(arr) {
      if (isTypedArray3(arr)) {
        var buf = import_buffer.Buffer.from(arr.buffer);
...
function hexToBuffer(hex) {
  return import_buffer.Buffer.from(removeHexPrefix(hex), ENC_HEX);
}
...
function utf8ToBuffer(utf8) {
  return import_buffer.Buffer.from(utf8, ENC_UTF8);
}
...
function isBuffer(val) {
  return import_buffer.Buffer.isBuffer(val);
}
...
function concatBuffers(...args) {
  const result = import_buffer.Buffer.concat(args);
  return result;
}
...
function concatArrayBuffers(...args) {
  return hexToArray(args.map((b) => arrayToHex(new Uint8Array(b))).join("")).buffer;
}
...
function j(n) {
  ...
  } }), B(y(P3, { context: e.context }, n.__v), e.l)) : e.l && e.componentWillUnmount();
}
function z(n, e) {
  var r = y(j, { __v: n, i: e });
...
function sn(n) {
  return an(n) ? E.apply(null, arguments) : n;
}
function hn(n) {
...
var R, N, A2, O, T2, I, W, B2, H, Z, Y, $, q2, K, tn, en, rn, un, on, ln, cn, dn, pn, mn, Sn, Cn;
var init_compat_module = __esm({
  "node_modules/preact/compat/dist/compat.module.js"() {
    ...
    init_hooks_module();
    init_hooks_module();
    (w.prototype = new k()).isPureReactComponent = true, w.prototype.shouldComponentUpdate = function(n, t) {
    ...
    }, (D2.prototype = new k()).__c = function(n, t) {
      var e = t.__c, r = this;
    ...
    (V2.prototype = new k()).__a = function(n) {
    ...
    l.vnode = function(n) {
      "string" == typeof n.type && function(n2) {
        ...
        "select" == e && u.multiple && Array.isArray(u.value) && (u.value = P(t.children).forEach(function(n3) {
          n3.props.selected = -1 != u.value.indexOf(n3.props.value);
        })), "select" == e && null != u.defaultValue && (u.value = P(t.children).forEach(function(n3) {
...
//# sourceMappingURL=index-42b0f5f5.browser.esm-FNAVXRLX.js.map
