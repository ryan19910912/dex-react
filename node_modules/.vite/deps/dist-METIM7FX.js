...
var cubicBezierAsString = ([a, b2, c2, d3]) => `cubic-bezier(${a}, ${b2}, ${c2}, ${d3})`;
...
var $e = (t, e, a) => e in t ? Ve(t, e, { enumerable: true, configurable: true, writable: true, value: a }) : t[e] = a;
var Wt = (t, e) => {
  for (var a in e || (e = {}))
    ze.call(e, a) && $e(t, a, e[a]);
  if (Ce)
    for (var a of Ce(e))
      Ge.call(e, a) && $e(t, a, e[a]);
  return t;
};
function Fe() {
  var t;
  const e = (t = ne.state.themeMode) != null ? t : "dark", a = { light: { foreground: { 1: "rgb(20,20,20)", 2: "rgb(121,134,134)", 3: "rgb(158,169,169)" }, background: { 1: "rgb(255,255,255)", 2: "rgb(241,243,243)", 3: "rgb(228,231,231)" }, overlay: "rgba(0,0,0,0.1)" }, dark: { foreground: { 1: "rgb(228,231,231)", 2: "rgb(148,158,158)", 3: "rgb(110,119,119)" }, background: { 1: "rgb(20,20,20)", 2: "rgb(39,42,42)", 3: "rgb(59,64,64)" }, overlay: "rgba(255,255,255,0.1)" } }[e];
...
function qe() {
  const { themeVariables: t } = ne.state;
  return { "--w3m-background-image-url": t != null && t["--w3m-background-image-url"] ? `url(${t["--w3m-background-image-url"]})` : "none" };
}
var p = { getPreset(t) {
  return ke()[t];
}, setTheme() {
  const t = document.querySelector(":root"), { themeVariables: e } = ne.state;
  if (t) {
    const a = Wt(Wt(Wt(Wt({}, Fe()), ke()), e), qe());
...
var Ke = css`button{display:flex;border-radius:var(--w3m-button-hover-highlight-border-radius);flex-direction:column;justify-content:center;padding:5px;width:100px}button:hover{background-color:var(--w3m-color-overlay)}button>div{display:flex;justify-content:center;align-items:center;width:32px;height:32px;box-shadow:inset 0 0 0 1px var(--w3m-color-overlay);background-color:var(--w3m-accent-color);border-radius:var(--w3m-icon-button-border-radius);margin-bottom:4px}button path{fill:var(--w3m-accent-fill-color)}`;
var Ye = Object.defineProperty;
var Qe = Object.getOwnPropertyDescriptor;
var At = (t, e, a, r) => {
  for (var o = r > 1 ? void 0 : r ? Qe(e, a) : e, i = t.length - 1, l; i >= 0; i--)
    (l = t[i]) && (o = (r ? l(e, a, o) : l(o)) || o);
  return r && o && Ye(e, a, o), o;
};
...
z.styles = [p.globalCss, Xe], lt([property()], z.prototype, "disabled", 2), lt([property()], z.prototype, "iconLeft", 2), lt([property()], z.prototype, "iconRight", 2), lt([property()], z.prototype, "onClick", 2), lt([property()], z.prototype, "variant", 2), z = lt([customElement("w3m-button")], z);
var eo = css`:host{display:inline-block}button{padding:0 15px 1px;height:40px;border-radius:var(--w3m-button-border-radius);color:var(--w3m-accent-fill-color);background-color:var(--w3m-accent-color)}button::after{content:'';top:0;bottom:0;left:0;right:0;position:absolute;background-color:transparent;border-radius:inherit;transition:background-color .2s ease;border:1px solid var(--w3m-color-overlay)}button:hover::after{background-color:var(--w3m-color-overlay)}button:disabled{padding-bottom:0;background-color:var(--w3m-color-bg-3);color:var(--w3m-color-fg-3)}.w3m-secondary{color:var(--w3m-accent-color);background-color:transparent}.w3m-secondary::after{display:none}`;
var oo = Object.defineProperty;
var ao = Object.getOwnPropertyDescriptor;
var Ft = (t, e, a, r) => {
  for (var o = r > 1 ? void 0 : r ? ao(e, a) : e, i = t.length - 1, l; i >= 0; i--)
    (l = t[i]) && (o = (r ? l(e, a, o) : l(o)) || o);
...
vt.styles = [p.globalCss, eo], Ft([property()], vt.prototype, "disabled", 2), Ft([property()], vt.prototype, "variant", 2), vt = Ft([customElement("w3m-button-big")], vt);
var ro = css`:host{background-color:var(--w3m-color-bg-2);border-top:1px solid var(--w3m-color-bg-3)}div{padding:10px 20px;display:inherit;flex-direction:inherit;align-items:inherit;width:inherit;justify-content:inherit}`;
var io = Object.defineProperty;
var lo = Object.getOwnPropertyDescriptor;
var no = (t, e, a, r) => {
  for (var o = r > 1 ? void 0 : r ? lo(e, a) : e, i = t.length - 1, l; i >= 0; i--)
    (l = t[i]) && (o = (r ? l(e, a, o) : l(o)) || o);
  return r && o && io(e, a, o), o;
};
...
var Mt = class extends LitElement {
  constructor() {
    super(), this.isHelp = false, this.unsubscribeRouter = void 0, this.unsubscribeRouter = f.subscribe((t) => {
  ...
  logoTemplate() {
    var t;
    const e = (t = ne.state.themeVariables) == null ? void 0 : t["--w3m-logo-image-url"];
    return e ? html`<img src="${e}">` : d2.WALLET_CONNECT_LOGO;
  }
  render() {
    const t = { "w3m-help-active": this.isHelp };
    return html`<div class="w3m-toolbar-placeholder"></div><div class="w3m-toolbar">${this.logoTemplate()}<div class="${classMap(t)}"><button @click="${this.onHelp}">${d2.HELP_ICON}</button> <button @click="${te.close}">${d2.CROSS_ICON}</button></div></div>`;
  }
};
Mt.styles = [p.globalCss, so], Oe([state()], Mt.prototype, "isHelp", 2), Mt = Oe([customElement("w3m-modal-backcard")], Mt);
var ho = css`main{padding:20px;padding-top:0;width:100%}`;
var wo = Object.defineProperty;
var po = Object.getOwnPropertyDescriptor;
var go = (t, e, a, r) => {
  for (var o = r > 1 ? void 0 : r ? po(e, a) : e, i = t.length - 1, l; i >= 0; i--)
    (l = t[i]) && (o = (r ? l(e, a, o) : l(o)) || o);
...
Kt.styles = [p.globalCss, ho], Kt = go([customElement("w3m-modal-content")], Kt);
var uo = css`footer{padding:10px;display:flex;flex-direction:column;align-items:inherit;justify-content:inherit;border-top:1px solid var(--w3m-color-bg-2)}`;
...
var Y = class extends LitElement {
  ...
  backBtnTemplate() {
    return html`<button class="w3m-back-btn" @click="${f.goBack}">${d2.BACK_ICON}</button>`;
  }
  actionBtnTemplate() {
    return html`<button class="w3m-action-btn" @click="${this.onAction}">${this.actionIcon}</button>`;
  }
  render() {
    const t = { "w3m-border": this.border }, e = f.state.history.length > 1, a = this.title ? html`<w3m-text variant="big-bold">${this.title}</w3m-text>` : html`<slot></slot>`;
    return html`<header class="${classMap(t)}">${e ? this.backBtnTemplate() : null} ${a} ${this.onAction ? this.actionBtnTemplate() : null}</header>`;
  }
};
Y.styles = [p.globalCss, xo], bt([property()], Y.prototype, "title", 2), bt([property()], Y.prototype, "onAction", 2), bt([property()], Y.prototype, "actionIcon", 2), bt([property()], Y.prototype, "border", 2), Y = bt([customElement("w3m-modal-header")], Y);
var $o = { 1: "692ed6ba-e569-459a-556a-776476829e00", 42161: "600a9a04-c1b9-42ca-6785-9b4b6ff85200", 43114: "30c46e53-e989-45fb-4549-be3bd4eb3b00", 56: "93564157-2e8e-4ce7-81df-b264dbee9b00", 250: "06b26297-fe0c-4733-5d6b-ffa5498aac00", 10: "ab9c186a-c52f-464b-2906-ca59d760a400", 137: "41d04d42-da3b-4453-8506-668cc0727900", 100: "02b53f6a-e3d4-479e-1cb4-21178987d100", 9001: "f926ff41-260d-4028-635e-91913fc28e00", 324: "b310f07f-4ef7-49f3-7073-2a0a39685800", 314: "5a73b3dd-af74-424e-cae0-0de859ee9400", 4689: "34e68754-e536-40da-c153-6ef2e7188a00", 1088: "3897a66d-40b9-4833-162f-a2c90531c900", 1284: "161038da-44ae-4ec7-1208-0ea569454b00", 1285: "f1d73bb6-5450-4e18-38f7-fb6484264a00" };
var ko = { ETH: { icon: "692ed6ba-e569-459a-556a-776476829e00" }, WETH: { icon: "692ed6ba-e569-459a-556a-776476829e00" }, AVAX: { icon: "30c46e53-e989-45fb-4549-be3bd4eb3b00" }, FTM: { icon: "06b26297-fe0c-4733-5d6b-ffa5498aac00" }, BNB: { icon: "93564157-2e8e-4ce7-81df-b264dbee9b00" }, MATIC: { icon: "41d04d42-da3b-4453-8506-668cc0727900" }, OP: { icon: "ab9c186a-c52f-464b-2906-ca59d760a400" }, xDAI: { icon: "02b53f6a-e3d4-479e-1cb4-21178987d100" }, EVMOS: { icon: "f926ff41-260d-4028-635e-91913fc28e00" }, METIS: { icon: "3897a66d-40b9-4833-162f-a2c90531c900" }, IOTX: { icon: "34e68754-e536-40da-c153-6ef2e7188a00" } };
var Z = { externalWallets() {
  const { isStandalone: t } = d.state;
  if (t)
    return [];
  let e = v.client().getConnectors();
  return e = e.filter((a) => a.id !== "injected"), e;
}, manualWallets() {
  var t, e;
  const { mobileWallets: a, desktopWallets: r } = b.state, o = (t = Z.recentWallet()) == null ? void 0 : t.id, i = c.isMobile() ? a : r, l = i == null ? void 0 : i.filter((w) => o !== w.id);
  return (e = c.isMobile() ? l == null ? void 0 : l.map(({ id: w, name: u, links: f2 }) => ({ id: w, name: u, mobile: f2, links: f2 })) : l == null ? void 0 : l.map(({ id: w, name: u, links: f2 }) => ({ id: w, name: u, desktop: f2, links: f2 }))) != null ? e : [];
}, installedInjectedWallets() {
  const { isStandalone: t } = d.state;
  if (t)
    return [];
  if (!v.client().isInjectedProviderInstalled())
    return [];
  const { namespace: e } = v.client(), { injectedWallets: a } = ee.state;
  let r = a.filter(({ injected: o }) => !!o.some((i) => v.client().safeCheckInjectedProvider(i.injected_id) && i.namespace === e));
  ...
  const { isStandalone: t } = d.state, { explorerExcludedWalletIds: e, explorerRecommendedWalletIds: a } = b.state, r = c.isMobile();
  if (t || e === "ALL" || r)
    return [];
  const { namespace: o } = v.client(), { injectedWallets: i } = ee.state;
  return i.filter(({ id: l, injected: w }) => {
    const u = c.isArray(e) ? e : [], f2 = c.isArray(a) ? a : [];
    return !!w.some((M) => M.namespace === o && !u.includes(l) && !f2.includes(l));
  });
}, recentWallet() {
  return s.getRecentWallet();
}, recomendedWallets(t = false) {
  var e;
  const a = Z.installedInjectedWallets().map(({ id: l }) => l), r = t || (e = Z.recentWallet()) == null ? void 0 : e.id, o = [...a, r], { recomendedWallets: i } = ee.state;
...
var s = { MOBILE_BREAKPOINT: 600, W3M_RECENT_WALLET_DATA: "W3M_RECENT_WALLET_DATA", EXPLORER_WALLET_URL: "https://explorer.walletconnect.com/?type=wallet", rejectStandaloneButtonComponent() {
  ...
  const { walletImages: a } = b.state;
  return a != null && a[t] ? a[t] : e ? ee.getWalletImageUrl(e) : "";
}, getWalletName(t, e = false) {
  return e ? t.split(" ")[0] : t;
}, getChainIcon(t) {
  var e;
  const a = $o[t], { projectId: r, chainImages: o } = b.state;
  return (e = o == null ? void 0 : o[t]) != null ? e : r && a ? ee.getAssetImageUrl(a) : "";
}, getTokenIcon(t) {
  var e, a;
  const r = (e = ko[t]) == null ? void 0 : e.icon, { projectId: o, tokenImages: i } = b.state;
  return (a = i == null ? void 0 : i[t]) != null ? a : o && r ? ee.getAssetImageUrl(r) : "";
}, isMobileAnimation() {
  ...
  const { standaloneUri: e } = d.state, { pairingUri: a } = x.state, { mobile: r, name: o } = t, i = r == null ? void 0 : r.native, l = r == null ? void 0 : r.universal;
  s.setRecentWallet(t);
  function w(u) {
    let f2 = "";
    i ? f2 = c.formatUniversalUrl(i, u, o) : l && (f2 = c.formatNativeUrl(l, u, o)), c.openHref(f2, "_self");
  }
  w(e || a);
}, handleAndroidLinking() {
  const { standaloneUri: t } = d.state, { pairingUri: e } = x.state;
  t ? (c.setWalletConnectAndroidDeepLink(t), c.openHref(t, "_self")) : (c.setWalletConnectAndroidDeepLink(e), c.openHref(e, "_self"));
}, async handleUriCopy() {
  const { standaloneUri: t } = d.state, { pairingUri: e } = x.state;
  t ? await navigator.clipboard.writeText(t) : await navigator.clipboard.writeText(e), se.openToast("Link copied", "success");
}, async handleConnectorConnection(t, e) {
  try {
    const { selectedChain: a } = d.state;
    await v.client().connectConnector(t, a == null ? void 0 : a.id), te.close();
  } catch (a) {
    console.error(a), e ? e() : se.openToast(s.getErrorMessage(a), "error");
  }
}, getCustomImageUrls() {
  const { chainImages: t, walletImages: e } = b.state, a = Object.values(t != null ? t : {}), r = Object.values(e != null ? e : {});
  ...
  if (o) {
    ...
    Object.entries(i).forEach(([l, w]) => o.style.setProperty(l, w));
  }
}, setRecentWallet(t) {
  ...
  const { id: t, desktop: e, mobile: a, injected: r } = c.getWalletRouterData(), o = Z.installedInjectedWallets(), i = !!(r != null && r.length), l = o.some((M) => M.id === t), w = !!(e != null && e.native), u = !!(e != null && e.universal), f2 = !!(a != null && a.native) || !!(a != null && a.universal);
  return { isInjectedInstalled: l, isInjected: i, isDesktop: w, isMobile: f2, isWeb: u };
  ...
  e ? i ? f.push("InjectedConnecting") : o ? f.push("MobileConnecting") : r ? f.push("WebConnecting") : f.push("InstallWallet") : i ? f.push("InjectedConnecting") : a ? f.push("DesktopConnecting") : r ? f.push("WebConnecting") : o ? f.push("MobileQrcodeConnecting") : f.push("InstallWallet");
} };
var Oo = css`.w3m-router{overflow:hidden;will-change:transform}.w3m-content{display:flex;flex-direction:column}`;
var Io = Object.defineProperty;
...
var ft = class extends LitElement {
  constructor() {
    super(), this.view = f.state.view, this.prevView = f.state.view, this.unsubscribe = void 0, this.oldHeight = "0px", this.resizeObserver = void 0, this.unsubscribe = f.subscribe((t) => {
  ...
  async onChangeRoute() {
    await animate2(this.routerEl, { opacity: [1, 0], scale: [1, 1.02] }, { duration: 0.15, delay: 0.1 }).finished, this.view = f.state.view, animate2(this.routerEl, { opacity: [0, 1], scale: [0.99, 1] }, { duration: 0.37, delay: 0.05 });
  }
  render() {
    return html`<div class="w3m-router"><div class="w3m-content">${this.viewTemplate()}</div></div>`;
  }
};
ft.styles = [p.globalCss, Oo], Qt([state()], ft.prototype, "view", 2), Qt([state()], ft.prototype, "prevView", 2), ft = Qt([customElement("w3m-modal-router")], ft);
var Wo = css`div{height:36px;width:max-content;display:flex;justify-content:center;align-items:center;padding:9px 15px 11px;position:absolute;top:12px;box-shadow:0 6px 14px -6px rgba(10,16,31,.3),0 10px 32px -4px rgba(10,16,31,.15);z-index:2;left:50%;transform:translateX(-50%);pointer-events:none;backdrop-filter:blur(20px) saturate(1.8);-webkit-backdrop-filter:blur(20px) saturate(1.8);border-radius:var(--w3m-notification-border-radius);border:1px solid var(--w3m-color-overlay);background-color:var(--w3m-color-overlay)}svg{margin-right:5px}@-moz-document url-prefix(){div{background-color:var(--w3m-color-bg-3)}}.w3m-success path{fill:var(--w3m-accent-color)}.w3m-error path{fill:var(--w3m-error-color)}`;
...
var jt = class extends LitElement {
  constructor() {
    super(), this.open = false, this.unsubscribe = void 0, this.timeout = void 0, this.unsubscribe = se.subscribe((t) => {
      t.open ? (this.open = true, this.timeout = setTimeout(() => se.closeToast(), 2200)) : (this.open = false, clearTimeout(this.timeout));
    });
  }
  disconnectedCallback() {
    var t;
    (t = this.unsubscribe) == null || t.call(this), clearTimeout(this.timeout), se.closeToast();
  }
  render() {
    const { message: t, variant: e } = se.state, a = { "w3m-success": e === "success", "w3m-error": e === "error" };
    return this.open ? html`<div class="${classMap(a)}">${e === "success" ? d2.CHECKMARK_ICON : null} ${e === "error" ? d2.CROSS_ICON : null}<w3m-text variant="small-regular">${t}</w3m-text></div>` : null;
  }
};
jt.styles = [p.globalCss, Wo], Ie([state()], jt.prototype, "open", 2), jt = Ie([customElement("w3m-modal-toast")], jt);
var jo = css`button{padding:5px;border-radius:var(--w3m-button-hover-highlight-border-radius);display:flex;flex-direction:column;align-items:center;justify-content:center;width:80px;height:90px}w3m-network-image{width:54px;height:59px}w3m-text{width:100%;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;text-align:center;margin-top:5px}button:hover{background-color:var(--w3m-color-overlay)}`;
...
var nt = class extends LitElement {
  ...
  render() {
    return html`<button @click="${this.onClick}"><w3m-network-image chainId="${this.chainId}"></w3m-network-image><w3m-text variant="xsmall-regular">${this.name}</w3m-text></button>`;
  }
};
nt.styles = [p.globalCss, jo], Pt([property()], nt.prototype, "onClick", 2), Pt([property()], nt.prototype, "name", 2), Pt([property()], nt.prototype, "chainId", 2), nt = Pt([customElement("w3m-network-button")], nt);
var Lo = css`@keyframes loading{to{stroke-dashoffset:0}}:host{width:inherit;height:inherit;position:relative}path{stroke:var(--w3m-color-overlay)}svg{width:100%;height:100%;margin:0}#network-placeholder-fill{fill:var(--w3m-color-bg-3)}#network-placeholder-dash{stroke:var(--w3m-color-overlay)}image{clip-path:path('M17.033 4.964c3.852-2.262 5.778-3.393 7.84-3.77a11.807 11.807 0 0 1 4.254 0c2.062.377 3.988 1.508 7.84 3.77l6.066 3.562c3.852 2.263 5.777 3.394 7.13 5.022a12.268 12.268 0 0 1 2.127 3.747c.71 2.006.71 4.268.71 8.793v7.124c0 4.525 0 6.787-.71 8.793a12.268 12.268 0 0 1-2.126 3.747c-1.354 1.628-3.28 2.76-7.131 5.022l-6.066 3.562c-3.852 2.262-5.778 3.393-7.84 3.771a11.814 11.814 0 0 1-4.254 0c-2.062-.378-3.988-1.509-7.84-3.77l-6.066-3.563c-3.852-2.263-5.778-3.394-7.13-5.022a12.268 12.268 0 0 1-2.127-3.747C1 40 1 37.737 1 33.212v-7.124c0-4.525 0-6.787.71-8.793a12.268 12.268 0 0 1 2.127-3.747c1.352-1.628 3.278-2.76 7.13-5.022l6.066-3.562Z')}`;
...
var Zo = { generate(t, e, a, r) {
  const o = r === "light" ? "#141414" : "#fff", i = r === "light" ? "#fff" : "#141414", l = [], w = Do(t, "Q"), u = e / w.length, f2 = [{ x: 0, y: 0 }, { x: 1, y: 0 }, { x: 0, y: 1 }];
  f2.forEach(({ x: W, y: k }) => {
    const L = (w.length - U) * u * W, I = (w.length - U) * u * k, D = 0.32;
    for (let S = 0; S < f2.length; S += 1) {
      const rt = u * (U - S * 2);
      l.push(svg`<rect fill="${S % 2 === 0 ? o : i}" height="${rt}" rx="${rt * D}" ry="${rt * D}" width="${rt}" x="${L + u * S}" y="${I + u * S}">`);
    }
  });
  const M = Math.floor((a + 25) / u), $ = w.length / 2 - M / 2, T = w.length / 2 + M / 2 - 1, ye = [];
  w.forEach((W, k) => {
    W.forEach((L, I) => {
      if (w[k][I] && !(k < U && I < U || k > w.length - (U + 1) && I < U || k < U && I > w.length - (U + 1)) && !(k > $ && k < T && I > $ && I < T)) {
...
var Lt = class extends LitElement {
  ...
  render() {
    ...
    return html`<input type="text" @input="${this.onChange}" placeholder="${t}"><div>${d2.SEARCH_ICON}<w3m-text color="secondary" variant="small-thin">${t}</w3m-text></div>`;
  }
};
Lt.styles = [p.globalCss, Uo], Ae([property()], Lt.prototype, "onChange", 2), Lt = Ae([customElement("w3m-search-input")], Lt);
var Go = css`@keyframes rotate{100%{transform:rotate(360deg)}}@keyframes dash{0%{stroke-dasharray:1,150;stroke-dashoffset:0}50%{stroke-dasharray:90,150;stroke-dashoffset:-35}100%{stroke-dasharray:90,150;stroke-dashoffset:-124}}svg{animation:rotate 2s linear infinite;display:flex;justify-content:center;align-items:center}svg circle{stroke-linecap:round;animation:dash 1.5s ease infinite;stroke:var(--w3m-accent-color)}`;
var Fo = Object.defineProperty;
var qo = Object.getOwnPropertyDescriptor;
var Ko = (t, e, a, r) => {
  for (var o = r > 1 ? void 0 : r ? qo(e, a) : e, i = t.length - 1, l; i >= 0; i--)
    (l = t[i]) && (o = (r ? l(e, a, o) : l(o)) || o);
...
var B2 = class extends LitElement {
  constructor() {
  ...
  handleClick() {
    _.click({ name: "WALLET_BUTTON", walletId: this.walletId }), this.onClick();
  }
  render() {
    var t;
...
B2.styles = [p.globalCss, oa], F([property()], B2.prototype, "onClick", 2), F([property()], B2.prototype, "name", 2), F([property()], B2.prototype, "walletId", 2), F([property()], B2.prototype, "label", 2), F([property()], B2.prototype, "imageId", 2), F([property()], B2.prototype, "installed", 2), F([property()], B2.prototype, "recent", 2), B2 = F([customElement("w3m-wallet-button")], B2);
var ia = css`:host{display:block}div{overflow:hidden;position:relative;border-radius:inherit;width:100%;height:100%;background-color:var(--w3m-color-overlay)}svg{position:relative;width:100%;height:100%}div::after{content:'';position:absolute;top:0;bottom:0;left:0;right:0;border-radius:inherit;border:1px solid var(--w3m-color-overlay)}div img{width:100%;height:100%;object-fit:cover;object-position:center}#wallet-placeholder-fill{fill:var(--w3m-color-bg-3)}#wallet-placeholder-dash{stroke:var(--w3m-color-overlay)}`;
var la = Object.defineProperty;
var na = Object.getOwnPropertyDescriptor;
var Rt = (t, e, a, r) => {
  for (var o = r > 1 ? void 0 : r ? na(e, a) : e, i = t.length - 1, l; i >= 0; i--)
    (l = t[i]) && (o = (r ? l(e, a, o) : l(o)) || o);
...
var ct = class extends LitElement {
  ...
  render() {
    ...
    return html`${e.length ? html`<div><img src="${e}" alt="${this.id}"></div>` : d2.WALLET_PLACEHOLDER}`;
  }
};
ct.styles = [p.globalCss, ia], Rt([property()], ct.prototype, "walletId", 2), Rt([property()], ct.prototype, "imageId", 2), Rt([property()], ct.prototype, "imageUrl", 2), ct = Rt([customElement("w3m-wallet-image")], ct);
var sa = Object.defineProperty;
var ca = Object.getOwnPropertyDescriptor;
var da = (t, e, a, r) => {
  for (var o = r > 1 ? void 0 : r ? ca(e, a) : e, i = t.length - 1, l; i >= 0; i--)
    (l = t[i]) && (o = (r ? l(e, a, o) : l(o)) || o);
  return r && o && sa(e, a, o), o;
};
var je = class extends LitElement {
  constructor() {
    super(), this.unwatchAccount = void 0, B.getAccount(), this.fetchProfile(), this.fetchBalance(), this.unwatchAccount = v.client().watchAccount((t) => {
      const { address: e, isConnected: a } = B.state;
      t.isConnected && t.address !== e && (this.fetchProfile(t.address), this.fetchBalance(t.address), B.setAddress(t.address)), t.isConnected || B.resetAccount(), a !== t.isConnected && te.close(), !a && t.isConnected ? _.track({ name: "ACCOUNT_CONNECTED" }) : a && !t.isConnected && _.track({ name: "ACCOUNT_DISCONNECTED" }), B.setIsConnected(t.isConnected);
    });
  }
  disconnectedCallback() {
    var t;
  ...
  async fetchProfile(t) {
    ...
    if (b.state.enableAccountView && a)
      try {
        await B.fetchProfile(s.preloadImage, t);
      } catch (r) {
        console.error(r), se.openToast(s.getErrorMessage(r), "error");
      }
  }
  async fetchBalance(t) {
    if (b.state.enableAccountView)
      try {
        await B.fetchBalance(t);
      } catch (e) {
        console.error(e), se.openToast(s.getErrorMessage(e), "error");
      }
  }
};
je = da([customElement("w3m-account-context")], je);
var ma = Object.defineProperty;
var ha = Object.getOwnPropertyDescriptor;
var Pe = (t, e, a, r) => {
  for (var o = r > 1 ? void 0 : r ? ha(e, a) : e, i = t.length - 1, l; i >= 0; i--)
    (l = t[i]) && (o = (r ? l(e, a, o) : l(o)) || o);
  return r && o && ma(e, a, o), o;
};
var ee2 = class extends LitElement {
  constructor() {
  ...
  async preloadListings() {
    ...
    if (b.state.enableExplorer) {
      ...
      await Promise.all([ee.getRecomendedWallets(), ee.getInjectedWallets()]), d.setIsDataLoaded(true);
      const { recomendedWallets: a } = ee.state, r = Z.installedInjectedWallets(), o = (t = e == null ? void 0 : e.map((w) => s.getChainIcon(w.id))) != null ? t : [], i = a.map((w) => s.getWalletIcon(w)), l = r.map((w) => s.getWalletIcon(w));
  ...
  async preloadData() {
    try {
      ...
      console.error(t), se.openToast("Failed preloading", "error");
    }
  }
};
Pe([state()], ee2.prototype, "preload", 2), ee2 = Pe([customElement("w3m-explorer-context")], ee2);
...
var oe = class extends LitElement {
  constructor() {
    ...
    this.activeChainId = t == null ? void 0 : t.id, this.unwatchNetwork = v.client().watchNetwork((e) => {
      const a = e.chain;
      a && this.activeChainId !== a.id && (d.setSelectedChain(a), this.activeChainId = a.id, B.resetBalance(), this.fetchBalance());
    });
  }
  disconnectedCallback() {
    var t;
  ...
  async fetchBalance() {
    if (b.state.enableAccountView)
      try {
        await B.fetchBalance();
      } catch (t) {
        console.error(t), se.openToast(s.getErrorMessage(t), "error");
      }
  }
};
Te([state()], oe.prototype, "activeChainId", 2), oe = Te([customElement("w3m-network-context")], oe);
...
var Le = class extends LitElement {
  constructor() {
    super(), this.unsubscribeTheme = void 0, p.setTheme(), this.unsubscribeTheme = ne.subscribe(p.setTheme), this.preloadThemeImages();
  }
  disconnectedCallback() {
    var t;
  ...
  async preloadThemeImages() {
    try {
      const { themeVariables: t } = ne.state, e = [t == null ? void 0 : t["--w3m-background-image-url"], t == null ? void 0 : t["--w3m-logo-image-url"]].filter(Boolean);
...
Le = va([customElement("w3m-theme-context")], Le);
...
var Ne = class extends LitElement {
  constructor() {
    super(), this.unwatchOptions = void 0, this.unwatchAccount = void 0, this.timeout = void 0, this.isGenerated = false, this.selectedChainId = (Re = d.state.selectedChain) == null ? void 0 : Re.id, this.isAccountConnected = B.state.isConnected, this.lastRetry = Date.now(), this.unwatchOptions = d.subscribe((t) => {
      var e, a;
    ...
    }), this.unwatchAccount = B.subscribe((t) => {
  ...
  async connectAndWait() {
    if (clearTimeout(this.timeout), !this.isAccountConnected) {
      this.isGenerated = true, this.timeout = setTimeout(this.connectAndWait.bind(this), ya);
      try {
        const { standaloneUri: t, selectedChain: e } = d.state;
        t ? x.setPairingUri(t) : await v.client().connectWalletConnect((a) => x.setPairingUri(a), e == null ? void 0 : e.id);
      } catch (t) {
        console.error(t), x.setPairingError(true), se.openToast("Connection request declined", "error"), Date.now() - this.lastRetry >= _e && (this.lastRetry = Date.now(), this.connectAndWait());
      }
    }
  }
  onVisibilityChange() {
    !document.hidden && c.isMobile() && setTimeout(this.connectAndWait.bind(this), _e);
  }
};
Ne = xa([customElement("w3m-wc-connection-context")], Ne);
var Ca = css`:host{all:initial}div{display:flex;align-items:center;background-color:var(--w3m-color-overlay);box-shadow:inset 0 0 0 1px var(--w3m-color-overlay);border-radius:var(--w3m-button-border-radius);padding:4px 4px 4px 8px}div button{border-radius:var(--w3m-secondary-button-border-radius);padding:4px 8px;padding-left:4px;height:auto;margin-left:10px;color:var(--w3m-accent-fill-color);background-color:var(--w3m-accent-color)}.w3m-no-avatar{padding-left:8px}button::after{content:'';top:0;bottom:0;left:0;right:0;position:absolute;background-color:transparent;border-radius:inherit;transition:background-color .2s ease;border:1px solid var(--w3m-color-overlay)}button:hover::after{background-color:var(--w3m-color-overlay)}w3m-avatar{margin-right:6px}w3m-button-big w3m-avatar{margin-left:-5px}`;
var $a = Object.defineProperty;
var ka = Object.getOwnPropertyDescriptor;
var ae = (t, e, a, r) => {
  for (var o = r > 1 ? void 0 : r ? ka(e, a) : e, i = t.length - 1, l; i >= 0; i--)
    (l = t[i]) && (o = (r ? l(e, a, o) : l(o)) || o);
  return r && o && $a(e, a, o), o;
};
var yt = class extends LitElement {
  constructor() {
  ...
  onOpen() {
    const { isStandalone: t } = d.state;
    t || (_.click({ name: "ACCOUNT_BUTTON" }), te.open({ route: "Account" }));
  }
  accountTemplate() {
...
yt.styles = [p.globalCss, Ca], ae([property()], yt.prototype, "balance", 2), ae([property()], yt.prototype, "avatar", 2), yt = ae([customElement("w3m-account-button")], yt);
var Oa = css`button{display:flex;border-radius:var(--w3m-button-hover-highlight-border-radius);flex-direction:column;justify-content:center;padding:5px;width:100px}button:hover{background-color:var(--w3m-color-overlay)}button:disabled{pointer-events:none}w3m-network-image{width:32px;height:32px}w3m-text{margin-top:4px}`;
...
Ct.styles = [p.globalCss, Oa], re([state()], Ct.prototype, "chainId", 2), re([state()], Ct.prototype, "label", 2), Ct = re([customElement("w3m-account-network-button")], Ct);
var Wa = css`@keyframes slide{0%{background-position:0 0}100%{background-position:200px 0}}w3m-text{padding:1px 0}.w3m-loading{background:linear-gradient(270deg,var(--w3m-color-fg-1) 36.33%,var(--w3m-color-fg-3) 42.07%,var(--w3m-color-fg-1) 83.3%);background-size:200px 100%;background-clip:text;-webkit-background-clip:text;-webkit-text-fill-color:transparent;animation-name:slide;animation-duration:1.5s;animation-iteration-count:infinite;animation-timing-function:linear}`;
var Aa = Object.defineProperty;
...
var Q = class extends LitElement {
  constructor() {
    super(), this.address = void 0, this.name = void 0, this.loading = true, this.variant = "button", this.unsubscribeAccount = void 0, this.address = B.state.address, this.name = B.state.profileName, this.loading = !!B.state.profileLoading, this.unsubscribeAccount = B.subscribe(({ address: t, profileName: e, profileLoading: a }) => {
...
Q.styles = [p.globalCss, Wa], $t([state()], Q.prototype, "address", 2), $t([state()], Q.prototype, "name", 2), $t([state()], Q.prototype, "loading", 2), $t([property()], Q.prototype, "variant", 2), Q = $t([customElement("w3m-address-text")], Q);
var j = { onConnecting(t) {
...
var ie = class extends LitElement {
  ...
  render() {
    const { recomendedWallets: t } = ee.state, e = [...t, ...t], a = j.externalWalletsTemplate(), r = j.installedInjectedWalletsTemplate(), o = [...r, ...a].length > 0, i = c.RECOMMENDED_WALLET_AMOUNT * 2;
    return html`<w3m-modal-header title="Connect your wallet" .onAction="${this.onGoToQrcode}" .actionIcon="${d2.QRCODE_ICON}"></w3m-modal-header><w3m-modal-content><div class="w3m-title">${d2.MOBILE_ICON}<w3m-text variant="small-regular" color="accent">WalletConnect</w3m-text></div><div class="w3m-slider"><div class="w3m-track">${[...Array(i)].map((l, w) => {
      const u = e[w % e.length];
      return u ? html`<w3m-wallet-image walletId="${u.id}" imageId="${u.image_id}"></w3m-wallet-image>` : d2.WALLET_PLACEHOLDER;
    })}</div><w3m-button-big @click="${s.handleAndroidLinking}"><w3m-text variant="medium-regular" color="inverse">Select Wallet</w3m-text></w3m-button-big></div></w3m-modal-content>${o ? html`<w3m-modal-footer><div class="w3m-title">${d2.WALLET_ICON}<w3m-text variant="small-regular" color="accent">Other</w3m-text></div><div class="w3m-grid">${r} ${a}</div></w3m-modal-footer>` : null}<w3m-info-footer><w3m-text color="secondary" variant="small-thin">${`Choose WalletConnect to see supported apps on your device${o ? ", or select from other options" : ""}`}</w3m-text><w3m-button variant="outline" .iconRight="${d2.ARROW_UP_RIGHT_ICON}" .onClick="${() => this.onGetWallet()}">I don't have a wallet</w3m-button></w3m-info-footer>`;
  }
};
ie.styles = [p.globalCss, ja], ie = La([customElement("w3m-android-wallet-selection")], ie);
var _a = css`@keyframes slide{0%{transform:translateX(-50px)}100%{transform:translateX(200px)}}.w3m-placeholder,img{border-radius:50%;box-shadow:inset 0 0 0 1px var(--w3m-color-overlay);display:block;position:relative;overflow:hidden!important;background-color:var(--w3m-color-av-1);background-image:radial-gradient(at 66% 77%,var(--w3m-color-av-2) 0,transparent 50%),radial-gradient(at 29% 97%,var(--w3m-color-av-3) 0,transparent 50%),radial-gradient(at 99% 86%,var(--w3m-color-av-4) 0,transparent 50%),radial-gradient(at 29% 88%,var(--w3m-color-av-5) 0,transparent 50%);transform:translateZ(0)}.w3m-loader{width:50px;height:100%;background:linear-gradient(270deg,transparent 0,rgba(255,255,255,.4) 30%,transparent 100%);animation-name:slide;animation-duration:1.5s;transform:translateX(-50px);animation-iteration-count:infinite;animation-timing-function:linear;animation-delay:.55s}.w3m-small{width:24px;height:24px}.w3m-medium{width:60px;height:60px}`;
...
var X = class extends LitElement {
  constructor() {
    super(), this.address = void 0, this.avatar = void 0, this.loading = true, this.size = "small", this.unsubscribeAccount = void 0, this.address = B.state.address, this.avatar = B.state.profileAvatar, this.loading = !!B.state.profileLoading, this.unsubscribeAccount = B.subscribe(({ address: t, profileAvatar: e, profileLoading: a }) => {
...
X.styles = [p.globalCss, _a], kt([state()], X.prototype, "address", 2), kt([state()], X.prototype, "avatar", 2), kt([state()], X.prototype, "loading", 2), kt([property()], X.prototype, "size", 2), X = kt([customElement("w3m-avatar")], X);
var Da = css`div{display:flex;align-items:center}w3m-token-image{width:28px;height:28px;margin-right:6px}`;
var Za = Object.defineProperty;
var Ha = Object.getOwnPropertyDescriptor;
var le = (t, e, a, r) => {
  for (var o = r > 1 ? void 0 : r ? Ha(e, a) : e, i = t.length - 1, l; i >= 0; i--)
    (l = t[i]) && (o = (r ? l(e, a, o) : l(o)) || o);
  return r && o && Za(e, a, o), o;
};
var Ot = class extends LitElement {
  constructor() {
    var t, e;
    super(), this.symbol = void 0, this.amount = void 0, this.unsubscribeAccount = void 0, this.symbol = (t = B.state.balance) == null ? void 0 : t.symbol, this.amount = (e = B.state.balance) == null ? void 0 : e.amount, this.unsubscribeAccount = B.subscribe(({ balance: a }) => {
...
Ot.styles = [p.globalCss, Da], le([state()], Ot.prototype, "symbol", 2), le([state()], Ot.prototype, "amount", 2), Ot = le([customElement("w3m-balance")], Ot);
var Sa = css`:host{all:initial}svg{width:28px;height:20px;margin:-1px 3px 0 -5px}svg path{fill:var(--w3m-accent-fill-color)}button:disabled svg path{fill:var(--w3m-color-fg-3)}w3m-spinner{margin:0 10px 0 0}`;
var Ba = Object.defineProperty;
var Ua = Object.getOwnPropertyDescriptor;
var Nt = (t, e, a, r) => {
  for (var o = r > 1 ? void 0 : r ? Ua(e, a) : e, i = t.length - 1, l; i >= 0; i--)
...
var dt = class extends LitElement {
  constructor() {
    super(), this.loading = false, this.label = "Connect Wallet", this.icon = "show", this.modalUnsub = void 0, s.rejectStandaloneButtonComponent(), this.modalUnsub = te.subscribe((t) => {
  ...
  iconTemplate() {
    return this.icon === "show" ? d2.WALLET_CONNECT_ICON : null;
  }
  onClick() {
    B.state.isConnected ? this.onDisconnect() : this.onConnect();
  }
  async onConnect() {
    this.loading = true, _.click({ name: "CONNECT_BUTTON" }), await te.open(), te.state.open || (this.loading = false);
  }
  async onDisconnect() {
    _.click({ name: "DISCONNECT_BUTTON" }), await v.client().disconnect();
  }
  render() {
...
var q = class extends LitElement {
  ...
  svgLoaderTemplate() {
    var t, e;
    const a = (e = (t = ne.state.themeVariables) == null ? void 0 : t["--w3m-wallet-icon-large-border-radius"]) != null ? e : p.getPreset("--w3m-wallet-icon-large-border-radius");
    let r = 0;
...
q.styles = [p.globalCss, Va], mt([property()], q.prototype, "walletId", 2), mt([property()], q.prototype, "imageId", 2), mt([property()], q.prototype, "isError", 2), mt([property()], q.prototype, "isStale", 2), mt([property()], q.prototype, "label", 2), q = mt([customElement("w3m-connector-waiting")], q);
var Fa = Object.defineProperty;
var qa = Object.getOwnPropertyDescriptor;
var ht = (t, e, a, r) => {
  for (var o = r > 1 ? void 0 : r ? qa(e, a) : e, i = t.length - 1, l; i >= 0; i--)
    (l = t[i]) && (o = (r ? l(e, a, o) : l(o)) || o);
  return r && o && Fa(e, a, o), o;
};
var J = class extends LitElement {
  constructor() {
    super(), this.isConnected = false, this.label = "Connect Wallet", this.icon = "show", this.avatar = "show", this.balance = "hide", this.unsubscribeAccount = void 0, s.rejectStandaloneButtonComponent(), this.isConnected = B.state.isConnected, this.unsubscribeAccount = B.subscribe(({ isConnected: t }) => {
      this.isConnected = t;
    });
  }
  disconnectedCallback() {
  ...
  render() {
    const { enableAccountView: t } = b.state, e = this.balance, a = this.label, r = this.icon, o = this.avatar;
...
var ne2 = class extends LitElement {
  render() {
    const { isStandalone: t } = d.state, { explorerExcludedWalletIds: e, enableExplorer: a } = b.state, r = e !== "ALL" && a, o = j.manualWalletsTemplate(), i = j.recomendedWalletsTemplate(), l = j.externalWalletsTemplate(), w = j.recentWalletTemplate(), u = j.installedInjectedWalletsTemplate();
    let f2 = [w, ...o, ...i];
    t || (f2 = [...u, w, ...l, ...o, ...i]), f2 = f2.filter(Boolean);
    const M = f2.length > 4 || r;
    let $ = [];
    M ? $ = f2.slice(0, 3) : $ = f2;
    const T = !!$.length;
    return html`<w3m-modal-header .border="${true}" title="Connect your wallet" .onAction="${s.handleUriCopy}" .actionIcon="${d2.COPY_ICON}"></w3m-modal-header><w3m-modal-content><div class="w3m-mobile-title"><div class="w3m-subtitle">${d2.MOBILE_ICON}<w3m-text variant="small-regular" color="accent">Mobile</w3m-text></div><div class="w3m-subtitle">${d2.SCAN_ICON}<w3m-text variant="small-regular" color="secondary">Scan with your wallet</w3m-text></div></div><w3m-walletconnect-qr></w3m-walletconnect-qr></w3m-modal-content>${T ? html`<w3m-modal-footer><div class="w3m-desktop-title">${d2.DESKTOP_ICON}<w3m-text variant="small-regular" color="accent">Desktop</w3m-text></div><div class="w3m-grid">${$} ${M ? html`<w3m-view-all-wallets-button></w3m-view-all-wallets-button>` : null}</div></w3m-modal-footer>` : null}`;
  }
};
ne2.styles = [p.globalCss, Ka], ne2 = Xa([customElement("w3m-desktop-wallet-selection")], ne2);
var Ja = css`div{background-color:var(--w3m-color-bg-2);padding:10px 20px 15px 20px;border-top:1px solid var(--w3m-color-bg-3);text-align:center}a{color:var(--w3m-accent-color);text-decoration:none;transition:opacity .2s ease-in-out;display:inline}a:hover{opacity:.8}`;
...
var se2 = class extends LitElement {
  render() {
    const { termsOfServiceUrl: t, privacyPolicyUrl: e } = b.state;
...
se2.styles = [p.globalCss, Ja], se2 = or([customElement("w3m-legal-notice")], se2);
var ar = css`div{display:grid;grid-template-columns:repeat(4,80px);margin:0 -10px;justify-content:space-between;row-gap:10px}`;
...
var ce = class extends LitElement {
  ...
  render() {
    ...
    let f2 = [w, ...o, ...i];
    t || (f2 = [...u, w, ...l, ...o, ...i]), f2 = f2.filter(Boolean);
    const M = f2.length > 8 || r;
    let $ = [];
    M ? $ = f2.slice(0, 7) : $ = f2;
    const T = !!$.length;
    return html`<w3m-modal-header title="Connect your wallet" .onAction="${this.onQrcode}" .actionIcon="${d2.QRCODE_ICON}"></w3m-modal-header>${T ? html`<w3m-modal-content><div>${$} ${M ? html`<w3m-view-all-wallets-button></w3m-view-all-wallets-button>` : null}</div></w3m-modal-content>` : null}`;
  }
};
ce.styles = [p.globalCss, ar], ce = lr([customElement("w3m-mobile-wallet-selection")], ce);
var nr = css`:host{all:initial}.w3m-overlay{top:0;bottom:0;left:0;right:0;position:fixed;z-index:var(--w3m-z-index);overflow:hidden;display:flex;justify-content:center;align-items:center;background-color:rgba(0,0,0,.3);opacity:0;pointer-events:none}@media(max-height:720px) and (orientation:landscape){.w3m-overlay{overflow:scroll;align-items:flex-start;padding:20px 0}}.w3m-active{pointer-events:auto}.w3m-container{position:relative;max-width:360px;width:100%;outline:0;border-radius:var(--w3m-background-border-radius) var(--w3m-background-border-radius) var(--w3m-container-border-radius) var(--w3m-container-border-radius);border:1px solid var(--w3m-color-overlay);overflow:hidden}.w3m-card{width:100%;position:relative;border-radius:var(--w3m-container-border-radius);overflow:hidden;box-shadow:0 6px 14px -6px rgba(10,16,31,.12),0 10px 32px -4px rgba(10,16,31,.1),0 0 0 1px var(--w3m-color-overlay);background-color:var(--w3m-color-bg-1);color:var(--w3m-color-fg-1)}@media(max-width:600px){.w3m-container{max-width:440px;border-radius:var(--w3m-background-border-radius) var(--w3m-background-border-radius) 0 0}.w3m-card{border-radius:var(--w3m-container-border-radius) var(--w3m-container-border-radius) 0 0}.w3m-overlay{align-items:flex-end}}@media(max-width:440px){.w3m-container{border:0}}`;
...
var It = class extends LitElement {
  constructor() {
    super(), this.open = false, this.active = false, this.unsubscribeModal = void 0, this.abortController = void 0, this.unsubscribeModal = te.subscribe((t) => {
  ...
  onCloseModal(t) {
    t.target === t.currentTarget && te.close();
  }
  onOpenModalEvent() {
  ...
  addKeyboardEvents() {
    this.abortController = new AbortController(), window.addEventListener("keydown", (t) => {
      var e;
      t.key === "Escape" ? te.close() : t.key === "Tab" && ((e = t.target) != null && e.tagName.includes("W3M-") || this.containerEl.focus());
...
It.styles = [p.globalCss, nr], de([state()], It.prototype, "open", 2), de([state()], It.prototype, "active", 2), It = de([customElement("w3m-modal")], It);
var dr = css`:host{all:initial}w3m-network-image{margin-left:-6px;margin-right:6px;width:28px;height:28px}`;
var mr = Object.defineProperty;
var hr = Object.getOwnPropertyDescriptor;
var Dt = (t, e, a, r) => {
  for (var o = r > 1 ? void 0 : r ? hr(e, a) : e, i = t.length - 1, l; i >= 0; i--)
    (l = t[i]) && (o = (r ? l(e, a, o) : l(o)) || o);
...
var wt = class extends LitElement {
  ...
  onClick() {
    _.click({ name: "NETWORK_BUTTON" }), te.open({ route: "SelectNetwork" });
  }
  render() {
    var t;
...
pt.styles = [p.globalCss, wr], Zt([property()], pt.prototype, "chainId", 2), Zt([property()], pt.prototype, "isError", 2), Zt([property()], pt.prototype, "label", 2), pt = Zt([customElement("w3m-network-waiting")], pt);
var ur = css`div{display:flex;margin-top:15px}slot{display:inline-block;margin:0 5px}w3m-button{margin:0 5px}`;
var vr = Object.defineProperty;
var br = Object.getOwnPropertyDescriptor;
var tt = (t, e, a, r) => {
  for (var o = r > 1 ? void 0 : r ? br(e, a) : e, i = t.length - 1, l; i >= 0; i--)
    (l = t[i]) && (o = (r ? l(e, a, o) : l(o)) || o);
  return r && o && vr(e, a, o), o;
};
var V = class extends LitElement {
  ...
  onMobile() {
    c.isMobile() ? f.replace("MobileConnecting") : f.replace("MobileQrcodeConnecting");
  }
  onInjected() {
    this.isInjectedInstalled ? f.replace("InjectedConnecting") : f.replace("InstallWallet");
  }
  onDesktop() {
    f.replace("DesktopConnecting");
  }
  onWeb() {
    f.replace("WebConnecting");
  }
  render() {
    const { isStandalone: t } = d.state;
    return html`<div>${this.isRetry ? html`<slot></slot>` : null} ${this.isMobile ? html`<w3m-button .onClick="${this.onMobile}" .iconLeft="${d2.MOBILE_ICON}" variant="outline">Mobile</w3m-button>` : null} ${this.isInjected && !t ? html`<w3m-button .onClick="${this.onInjected}" .iconLeft="${d2.WALLET_ICON}" variant="outline">Browser</w3m-button>` : null} ${this.isDesktop ? html`<w3m-button .onClick="${this.onDesktop}" .iconLeft="${d2.DESKTOP_ICON}" variant="outline">Desktop</w3m-button>` : null} ${this.isWeb ? html`<w3m-button .onClick="${this.onWeb}" .iconLeft="${d2.GLOBE_ICON}" variant="outline">Web</w3m-button>` : null}</div>`;
  }
};
V.styles = [p.globalCss, ur], tt([property()], V.prototype, "isMobile", 2), tt([property()], V.prototype, "isInjected", 2), tt([property()], V.prototype, "isInjectedInstalled", 2), tt([property()], V.prototype, "isDesktop", 2), tt([property()], V.prototype, "isWeb", 2), tt([property()], V.prototype, "isRetry", 2), V = tt([customElement("w3m-platform-selection")], V);
var fr = css`button{display:flex;flex-direction:column;padding:5px 10px;border-radius:var(--w3m-button-hover-highlight-border-radius);height:100%;justify-content:flex-start}.w3m-icons{width:60px;height:60px;display:flex;flex-wrap:wrap;padding:7px;border-radius:var(--w3m-wallet-icon-border-radius);justify-content:space-between;align-items:center;margin-bottom:5px;background-color:var(--w3m-color-bg-2);box-shadow:inset 0 0 0 1px var(--w3m-color-overlay)}button:hover{background-color:var(--w3m-color-overlay)}.w3m-icons img{width:21px;height:21px;object-fit:cover;object-position:center;border-radius:calc(var(--w3m-wallet-icon-border-radius)/ 2);border:1px solid var(--w3m-color-overlay)}.w3m-icons svg{width:21px;height:21px}.w3m-icons img:nth-child(1),.w3m-icons img:nth-child(2),.w3m-icons svg:nth-child(1),.w3m-icons svg:nth-child(2){margin-bottom:4px}w3m-text{width:100%;text-align:center}#wallet-placeholder-fill{fill:var(--w3m-color-bg-3)}#wallet-placeholder-dash{stroke:var(--w3m-color-overlay)}`;
...
var me = class extends LitElement {
  onClick() {
    f.push("WalletExplorer");
  }
  render() {
    const { recomendedWallets: t } = ee.state, e = Z.manualWallets(), a = [...t, ...e].reverse().slice(0, 4);
    return html`<button @click="${this.onClick}"><div class="w3m-icons">${a.map((r) => {
      ...
      return i ? html`<img src="${i}">` : d2.WALLET_PLACEHOLDER;
    })} ${[...Array(4 - a.length)].map(() => d2.WALLET_PLACEHOLDER)}</div><w3m-text variant="xsmall-regular">View All</w3m-text></button>`;
  }
};
me.styles = [p.globalCss, fr], me = Cr([customElement("w3m-view-all-wallets-button")], me);
var $r = css`.w3m-qr-container{width:100%;display:flex;justify-content:center;align-items:center;aspect-ratio:1/1}`;
...
var gt = class extends LitElement {
  constructor() {
    super(), this.walletId = "", this.imageId = "", this.uri = "", this.unwatchWcConnection = void 0, setTimeout(() => {
      const { pairingUri: t } = x.state, { standaloneUri: e } = d.state;
      this.uri = e != null ? e : t;
    }, 0), this.unwatchWcConnection = x.subscribe((t) => {
...
gt.styles = [p.globalCss, $r], Ht([property()], gt.prototype, "walletId", 2), Ht([property()], gt.prototype, "imageId", 2), Ht([state()], gt.prototype, "uri", 2), gt = Ht([customElement("w3m-walletconnect-qr")], gt);
var Ir = css`.w3m-profile{display:flex;justify-content:space-between;align-items:flex-start;padding-top:20px}.w3m-connection-badge{background-color:var(--w3m-color-bg-2);box-shadow:inset 0 0 0 1px var(--w3m-color-overlay);padding:6px 10px 6px 26px;position:relative;border-radius:28px}.w3m-connection-badge::before{content:'';position:absolute;width:10px;height:10px;left:10px;background-color:var(--w3m-success-color);border-radius:50%;top:50%;margin-top:-5px;box-shadow:0 1px 4px 1px var(--w3m-success-color),inset 0 0 0 1px var(--w3m-color-overlay)}.w3m-footer{display:flex;justify-content:space-between}w3m-address-text{margin-top:10px;display:block}.w3m-balance{border-top:1px solid var(--w3m-color-bg-2);padding:11px 20px}`;
var Er = Object.defineProperty;
var Wr = Object.getOwnPropertyDescriptor;
var Ar = (t, e, a, r) => {
  for (var o = r > 1 ? void 0 : r ? Wr(e, a) : e, i = t.length - 1, l; i >= 0; i--)
    (l = t[i]) && (o = (r ? l(e, a, o) : l(o)) || o);
  return r && o && Er(e, a, o), o;
};
...
we.styles = [p.globalCss], we = Pr([customElement("w3m-connect-wallet-view")], we);
var Tr = css`w3m-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}w3m-text{text-align:center}`;
...
var St = class extends LitElement {
  constructor() {
    super(), this.isError = false, this.unwatchConnection = void 0, this.openDesktopApp(), this.unwatchConnection = x.subscribe((t) => {
  ...
  openDesktopApp() {
    x.setPairingError(false);
    const { standaloneUri: t } = d.state, { pairingUri: e } = x.state, a = c.getWalletRouterData();
  ...
  render() {
    ...
    return html`<w3m-modal-header title="${t}" .onAction="${s.handleUriCopy}" .actionIcon="${d2.COPY_ICON}"></w3m-modal-header><w3m-modal-content><w3m-connector-waiting walletId="${e}" imageId="${a}" label="${`Continue in ${t}...`}" .isError="${this.isError}"></w3m-connector-waiting></w3m-modal-content><w3m-info-footer><w3m-text color="secondary" variant="small-thin">${`Connection can continue loading if ${t} is not installed on your device`}</w3m-text><w3m-platform-selection .isMobile="${r}" .isInjected="${o}" .isWeb="${i}" .isRetry="${true}"><w3m-button .onClick="${this.openDesktopApp.bind(this)}" .iconRight="${d2.RETRY_ICON}">Retry</w3m-button></w3m-platform-selection></w3m-info-footer>`;
  }
};
St.styles = [p.globalCss, Tr], De([state()], St.prototype, "isError", 2), St = De([customElement("w3m-desktop-connecting-view")], St);
var Rr = css`.w3m-info-text{margin:5px 0 15px;max-width:320px;text-align:center}.w3m-wallet-item{margin:0 -20px 0 0;padding-right:20px;display:flex;align-items:center;border-bottom:1px solid var(--w3m-color-bg-2)}.w3m-wallet-item:last-child{margin-bottom:-20px;border-bottom:0}.w3m-wallet-content{margin-left:20px;height:60px;display:flex;flex:1;align-items:center;justify-content:space-between}.w3m-footer-actions{display:flex;flex-direction:column;align-items:center;padding:20px 0;border-top:1px solid var(--w3m-color-bg-2)}w3m-wallet-image{display:block;width:40px;height:40px;border-radius:10px}`;
var Nr = Object.defineProperty;
var Dr = Object.getOwnPropertyDescriptor;
var Zr = (t, e, a, r) => {
  for (var o = r > 1 ? void 0 : r ? Dr(e, a) : e, i = t.length - 1, l; i >= 0; i--)
    (l = t[i]) && (o = (r ? l(e, a, o) : l(o)) || o);
  return r && o && Nr(e, a, o), o;
};
...
var ge = class extends LitElement {
  ...
  onGet() {
    b.state.enableExplorer ? f.push("GetWallet") : s.openWalletExplorerUrl();
  }
  onLearnMore() {
    c.openHref(this.learnUrl, "_blank");
  }
  render() {
    return html`<w3m-modal-header title="What is a wallet?"></w3m-modal-header><w3m-modal-content><div class="w3m-info-container"><div class="w3m-images">${d2.HELP_CHART_IMG} ${d2.HELP_PAINTING_IMG} ${d2.HELP_ETH_IMG}</div><w3m-text variant="medium-regular">A home for your digital assets</w3m-text><w3m-text variant="small-thin" color="secondary" class="w3m-info-text">A wallet lets you store, send and receive digital assets like cryptocurrencies and NFTs.</w3m-text></div><div class="w3m-info-container"><div class="w3m-images">${d2.HELP_KEY_IMG} ${d2.HELP_USER_IMG} ${d2.HELP_LOCK_IMG}</div><w3m-text variant="medium-regular">One login for all of web3</w3m-text><w3m-text variant="small-thin" color="secondary" class="w3m-info-text">Log in to any app by connecting your wallet. Say goodbye to countless passwords!</w3m-text></div><div class="w3m-info-container"><div class="w3m-images">${d2.HELP_COMPAS_IMG} ${d2.HELP_NOUN_IMG} ${d2.HELP_DAO_IMG}</div><w3m-text variant="medium-regular">Your gateway to a new web</w3m-text><w3m-text variant="small-thin" color="secondary" class="w3m-info-text">With your wallet, you can explore and interact with DeFi, NFTs, DAOs, and much more.</w3m-text></div><div class="w3m-footer-actions"><w3m-button .onClick="${this.onGet.bind(this)}" .iconLeft="${d2.WALLET_ICON}">Get a Wallet</w3m-button><w3m-button .onClick="${this.onLearnMore.bind(this)}" .iconRight="${d2.ARROW_UP_RIGHT_ICON}">Learn More</w3m-button></div></w3m-modal-content>`;
  }
};
ge.styles = [p.globalCss, Hr], ge = Ur([customElement("w3m-help-view")], ge);
var Vr = css`w3m-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}w3m-text{text-align:center}`;
...
var Bt = class extends LitElement {
  constructor() {
    super(), this.isError = false, this.connector = v.client().getConnectorById("injected"), this.openInjectedApp();
  }
  ...
  render() {
    ...
    return html`<w3m-modal-header title="${t}"></w3m-modal-header><w3m-modal-content><w3m-connector-waiting walletId="${e}" imageId="${a}" label="${`Continue in ${t}...`}" .isError="${this.isError}"></w3m-connector-waiting></w3m-modal-content><w3m-info-footer><w3m-text color="secondary" variant="small-thin">Connection can be declined if multiple wallets are installed or previous request is still active</w3m-text><w3m-platform-selection .isMobile="${r}" .isDesktop="${o}" .isWeb="${i}" .isRetry="${true}"><w3m-button .onClick="${this.openInjectedApp.bind(this)}" .disabled="${!this.isError}" .iconRight="${d2.RETRY_ICON}">Retry</w3m-button></w3m-platform-selection></w3m-info-footer>`;
  }
};
Bt.styles = [p.globalCss, Vr], Ze([state()], Bt.prototype, "isError", 2), Bt = Ze([customElement("w3m-injected-connecting-view")], Bt);
var Fr = css`w3m-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}w3m-text{text-align:center}w3m-button{margin-top:15px}`;
var qr = Object.defineProperty;
var Kr = Object.getOwnPropertyDescriptor;
var Yr = (t, e, a, r) => {
  for (var o = r > 1 ? void 0 : r ? Kr(e, a) : e, i = t.length - 1, l; i >= 0; i--)
    (l = t[i]) && (o = (r ? l(e, a, o) : l(o)) || o);
...
var Ut = class extends LitElement {
  constructor() {
    super(), this.isError = false, this.unwatchConnection = void 0, this.openMobileApp(), this.unwatchConnection = x.subscribe((t) => {
      this.isError = t.pairingError;
    });
  }
  disconnectedCallback() {
  ...
  openMobileApp(t = false) {
    x.setPairingError(false);
    const { standaloneUri: e } = d.state, { pairingUri: a } = x.state, r = c.getWalletRouterData();
  ...
  render() {
    const { name: t, id: e, image_id: a, app: r, mobile: o } = c.getWalletRouterData(), { isWeb: i } = s.getCachedRouterWalletPlatforms(), l = r == null ? void 0 : r.ios, w = o == null ? void 0 : o.universal;
    return html`<w3m-modal-header title="${t}"></w3m-modal-header><w3m-modal-content><w3m-connector-waiting walletId="${e}" imageId="${a}" label="Tap 'Open' to continue…" .isError="${this.isError}"></w3m-connector-waiting></w3m-modal-content><w3m-info-footer class="w3m-note"><w3m-text color="secondary" variant="small-thin">You can reload the website to try again ${w ? ` or open ${t} using a "Backup" instead` : ""}</w3m-text><w3m-platform-selection .isWeb="${i}" .isRetry="${true}"><div><w3m-button .onClick="${() => this.openMobileApp(false)}" .iconRight="${d2.RETRY_ICON}">Retry</w3m-button>${w ? html`<w3m-button variant="outline" .onClick="${() => this.openMobileApp(true)}" .iconRight="${d2.ARROW_UP_RIGHT_ICON}">Backup</w3m-button>` : null}</div></w3m-platform-selection></w3m-info-footer><w3m-info-footer class="w3m-app-store"><div><w3m-wallet-image walletId="${e}" imageId="${a}"></w3m-wallet-image><w3m-text>${`Get ${t}`}</w3m-text></div><w3m-button .iconRight="${d2.ARROW_RIGHT_ICON}" .onClick="${() => this.onGoToAppStore(l)}" variant="ghost">App Store</w3m-button></w3m-info-footer>`;
  }
};
Ut.styles = [p.globalCss, Qr], He([state()], Ut.prototype, "isError", 2), Ut = He([customElement("w3m-mobile-connecting-view")], Ut);
var ti = css`w3m-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}w3m-text{text-align:center}`;
var ei = Object.defineProperty;
var oi = Object.getOwnPropertyDescriptor;
var ai = (t, e, a, r) => {
  for (var o = r > 1 ? void 0 : r ? oi(e, a) : e, i = t.length - 1, l; i >= 0; i--)
    (l = t[i]) && (o = (r ? l(e, a, o) : l(o)) || o);
...
var ve = class extends LitElement {
  render() {
    ...
    return html`<w3m-modal-header title="${t}" .onAction="${s.handleUriCopy}" .actionIcon="${d2.COPY_ICON}"></w3m-modal-header><w3m-modal-content><w3m-walletconnect-qr walletId="${e}" imageId="${a}"></w3m-walletconnect-qr></w3m-modal-content><w3m-info-footer><w3m-text color="secondary" variant="small-thin">${`Scan this qrcode with your phone's camera or inside ${t} app`}</w3m-text><w3m-platform-selection .isDesktop="${o}" .isInjected="${r}" .isWeb="${i}"></w3m-platform-selection></w3m-info-footer>`;
  }
};
ve.styles = [p.globalCss, ti], ve = ai([customElement("w3m-mobile-qr-connecting-view")], ve);
var ri = Object.defineProperty;
var ii = Object.getOwnPropertyDescriptor;
var li = (t, e, a, r) => {
  for (var o = r > 1 ? void 0 : r ? ii(e, a) : e, i = t.length - 1, l; i >= 0; i--)
    (l = t[i]) && (o = (r ? l(e, a, o) : l(o)) || o);
  return r && o && ri(e, a, o), o;
};
var be = class extends LitElement {
  render() {
    return html`<w3m-modal-header title="Scan the code" .onAction="${s.handleUriCopy}" .actionIcon="${d2.COPY_ICON}"></w3m-modal-header><w3m-modal-content><w3m-walletconnect-qr></w3m-walletconnect-qr></w3m-modal-content>`;
  }
};
be.styles = [p.globalCss], be = li([customElement("w3m-qrcode-view")], be);
var ni = css`div{display:grid;grid-template-columns:repeat(4,80px);margin:-5px -10px;justify-content:space-between}`;
...
var fe = class extends LitElement {
  async onSelectChain(t) {
    try {
      const { selectedChain: e, walletConnectVersion: a, isInjectedMobile: r } = d.state, { isConnected: o } = B.state;
      o ? (e == null ? void 0 : e.id) === t.id ? f.reset("Account") : a === 2 ? (await v.client().switchNetwork({ chainId: t.id }), f.reset("Account")) : f.push("SwitchNetwork", { SwitchNetwork: t }) : r ? (d.setSelectedChain(t), te.close()) : (d.setSelectedChain(t), f.push("ConnectWallet"));
    } catch (e) {
      console.error(e), se.openToast(s.getErrorMessage(e), "error");
    }
  }
  render() {
    const { chains: t } = d.state;
    return html`<w3m-modal-header title="Select network"></w3m-modal-header><w3m-modal-content><div>${t == null ? void 0 : t.map((e) => html`<w3m-network-button name="${e.name}" chainId="${e.id}" .onClick="${async () => this.onSelectChain(e)}">${e.name}</w3m-network-button>`)}</div></w3m-modal-content>`;
  }
};
fe.styles = [p.globalCss, ni], fe = di([customElement("w3m-select-network-view")], fe);
var mi = css`w3m-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}w3m-text{text-align:center}w3m-button{margin-top:15px}`;
var hi = Object.defineProperty;
var wi = Object.getOwnPropertyDescriptor;
var Se = (t, e, a, r) => {
  for (var o = r > 1 ? void 0 : r ? wi(e, a) : e, i = t.length - 1, l; i >= 0; i--)
    (l = t[i]) && (o = (r ? l(e, a, o) : l(o)) || o);
  return r && o && hi(e, a, o), o;
};
var Vt = class extends LitElement {
  constructor() {
  ...
  async onSwitchNetwork() {
    try {
      ...
      await v.client().switchNetwork({ chainId: t.id }), d.setSelectedChain(t), f.reset("Account");
    } catch {
      this.isError = true;
    }
  }
...
var et = class extends LitElement {
  ...
  isLastPage() {
    const { wallets: t, search: e } = ee.state, { listings: a, total: r } = this.search ? e : t;
    return r <= xe || a.length >= r;
  }
  async fetchWallets() {
    var t;
    const { wallets: e, search: a, injectedWallets: r } = ee.state, { listings: o, total: i, page: l } = this.search ? a : e;
    if (!this.endReached && (this.firstFetch || i > xe && o.length < i))
      try {
        this.loading = true;
        const w = (t = d.state.standaloneChains) == null ? void 0 : t.join(","), { listings: u } = await ee.getWallets({ page: this.firstFetch ? 1 : l + 1, entries: xe, search: this.search, version: d.state.walletConnectVersion, chains: w }), f2 = u.map(($) => s.getWalletIcon($)), M = r.map(($) => s.getWalletIcon($));
        await Promise.all([...f2.map(async ($) => s.preloadImage($)), ...M.map(async ($) => s.preloadImage($)), c.wait(300)]), this.endReached = this.isLastPage();
      } catch (w) {
        console.error(w), se.openToast(s.getErrorMessage(w), "error");
      } finally {
  ...
  render() {
    const { wallets: t, search: e } = ee.state, { listings: a } = this.search ? e : t, r = this.loading && !a.length, o = this.search.length >= 3;
    let i = j.injectedWalletsTemplate(), l = j.manualWalletsTemplate(), w = j.recomendedWalletsTemplate(true);
    o && (i = i.filter(({ values: $ }) => s.caseSafeIncludes($[0], this.search)), l = l.filter(({ values: $ }) => s.caseSafeIncludes($[0], this.search)), w = w.filter(({ values: $ }) => s.caseSafeIncludes($[0], this.search)));
    const u = !this.loading && !a.length && !i.length && !w.length, f2 = Math.max(i.length, a.length), M = { "w3m-loading": r, "w3m-end-reached": this.endReached || !this.loading, "w3m-empty": u };
    return html`<w3m-modal-header><w3m-search-input .onChange="${this.onSearchChange.bind(this)}"></w3m-search-input></w3m-modal-header><w3m-modal-content class="${classMap(M)}"><div class="w3m-grid">${r ? null : w} ${r ? null : [...Array(f2)].map(($, T) => html`${l[T]} ${i[T]} ${a[T] ? html`<w3m-wallet-button imageId="${a[T].image_id}" name="${a[T].name}" walletId="${a[T].id}" .onClick="${() => this.onConnect(a[T])}"></w3m-wallet-button>` : null}`)}</div><div class="w3m-placeholder-block">${u ? html`<w3m-text variant="big-bold" color="secondary">No results found</w3m-text>` : null} ${!u && this.loading ? html`<w3m-spinner></w3m-spinner>` : null}</div></w3m-modal-content>`;
  }
};
et.styles = [p.globalCss, pi], Et([state()], et.prototype, "loading", 2), Et([state()], et.prototype, "firstFetch", 2), Et([state()], et.prototype, "search", 2), Et([state()], et.prototype, "endReached", 2), et = Et([customElement("w3m-wallet-explorer-view")], et);
var vi = css`w3m-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}w3m-text{text-align:center}`;
var bi = Object.defineProperty;
var fi = Object.getOwnPropertyDescriptor;
var Be = (t, e, a, r) => {
  for (var o = r > 1 ? void 0 : r ? fi(e, a) : e, i = t.length - 1, l; i >= 0; i--)
    (l = t[i]) && (o = (r ? l(e, a, o) : l(o)) || o);
  return r && o && bi(e, a, o), o;
};
var zt = class extends LitElement {
  constructor() {
    super(), this.isError = false, this.unwatchConnection = void 0, this.openWebWallet(), this.unwatchConnection = x.subscribe((t) => {
      this.isError = t.pairingError;
    });
  }
  disconnectedCallback() {
  ...
  render() {
    ...
    return html`<w3m-modal-header title="${t}" .onAction="${s.handleUriCopy}" .actionIcon="${d2.COPY_ICON}"></w3m-modal-header><w3m-modal-content><w3m-connector-waiting walletId="${e}" imageId="${a}" label="${`Continue in ${t}...`}" .isError="${this.isError}"></w3m-connector-waiting></w3m-modal-content><w3m-info-footer><w3m-text color="secondary" variant="small-thin">${`${t} web app has opened in a new tab. Go there, accept the connection, and come back`}</w3m-text><w3m-platform-selection .isMobile="${r}" .isInjected="${l ? false : o}" .isDesktop="${l ? false : i}" .isRetry="${true}"><w3m-button .onClick="${this.openWebWallet.bind(this)}" .iconRight="${d2.RETRY_ICON}">Retry</w3m-button></w3m-platform-selection></w3m-info-footer>`;
  }
};
zt.styles = [p.globalCss, vi], Be([state()], zt.prototype, "isError", 2), zt = Be([customElement("w3m-web-connecting-view")], zt);
export {
  yt as W3mAccountButton,
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
//# sourceMappingURL=dist-METIM7FX.js.map
