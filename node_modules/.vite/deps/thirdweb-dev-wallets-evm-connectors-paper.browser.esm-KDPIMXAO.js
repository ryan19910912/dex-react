...
var PaperWalletConnector = class extends TWConnector {
  constructor(options) {
    super();
  ...
  async connect() {
    ...
    switch (user.status) {
      ...
      case b.LOGGED_IN_WALLET_INITIALIZED: {
        this.user = user;
        break;
      }
    }
...
//# sourceMappingURL=thirdweb-dev-wallets-evm-connectors-paper.browser.esm-KDPIMXAO.js.map
