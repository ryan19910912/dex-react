...
var m = (o, e) => {
  ...
  if (i)
    for (var t of i(e))
      b2.call(e, t) && a(o, t, e[t]);
  return o;
};
var f = class {
  constructor(e) {
    this.openModal = te.open, this.closeModal = te.close, this.subscribeModal = te.subscribe, this.setTheme = ne.setThemeConfig, ne.setThemeConfig(e), b.setConfig(m({ enableStandaloneMode: true }, e)), this.initUi();
  }
  async initUi() {
    if (typeof window < "u") {
      await import("./dist-YY55NAPA.js");
...
//# sourceMappingURL=dist-P3NWUAYP.js.map
