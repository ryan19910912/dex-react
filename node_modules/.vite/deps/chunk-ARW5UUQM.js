...
var SafeConnector = class extends TWConnector {
  constructor() {
    super();
  ...
  async createSafeSigner(params) {
    ...
    safeSigner.signMessage = async (message) => {
      ...
      const encodedMessage = ethers_exports.utils._TypedDataEncoder.hash({
        verifyingContract: safeAddress,
        chainId: await this.getChainId()
      }, EIP712_SAFE_MESSAGE_TYPE, {
        message: ethers_exports.utils.hashMessage(message)
      });
      const safeMessage = ethers_exports.utils.arrayify(encodedMessage);
...
//# sourceMappingURL=chunk-ARW5UUQM.js.map
