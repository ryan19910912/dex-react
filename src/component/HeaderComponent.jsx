    ...
    return (
        <>
            <Menu onClick={onClick} selectedKeys={[current]} mode="horizontal" theme="dark" >
                ...
                <Menu.Item id="wallet" key="wallet" icon={<WalletTwoTone style={fontSize} />} style={menuStyle}>
                    <Link to="wallet" style={fontSize}>Wallet</Link>
                </Menu.Item>
                <Menu.Item id="swap" key="swap" icon={<InteractionTwoTone style={fontSize} />} style={menuStyle}>
                    <Link to="swap" style={fontSize}>Swap</Link>
                </Menu.Item>
                <Menu.Item id="pool" key="pool" icon={<DollarTwoTone style={fontSize} />} style={menuStyle}>
                    <Link to="pool" style={fontSize}>Pool</Link>
                </Menu.Item>
                <Menu.Item id="staking" key="staking" icon={<BankTwoTone style={fontSize} />} style={menuStyle}>
                    <Link to="staking" style={fontSize}>Staking</Link>
                </Menu.Item>
                <Menu.Item id="airdrop" key="airdrop" icon={<GiftTwoTone style={fontSize} />} style={menuStyle}>
